...
| 方式                 | 优点     | 缺点                             |
| -------------------- | -------- | -------------------------------- |
| **手动复制**         | 简单直接 | 每次都要改格式、传图片，太麻烦   |
| **Obsidian Publish** | 原生支持 | 付费（$8/月），自定义域名另收费  |
| **第三方同步工具**   | 一键同步 | 需要学习成本，格式兼容性不一定好 |
| **自己搭建**         | 完全可控 | 技术门槛高，维护成本大           |
...
| 框架        | 特点                   | 适合场景       |
| ----------- | ---------------------- | -------------- |
| **Hexo**    | 中文社区活跃，主题多   | 中文博客首选   |
| **Hugo**    | 编译速度极快           | 内容量大的站点 |
| **Next.js** | React 生态，动态能力强 | 需要交互的博客 |
| **Astro**   | 零 JS 默认，性能优秀   | 内容为主的博客 |
...
| ----------- | ------------ | ----------------- |
| Title       | Title        | 文章标题          |
| Description | Rich Text    | 文章描述/摘要     |
| Author      | Rich Text    | 作者              |
| PublishDate | Date         | 发布日期          |
| Tags        | Multi-select | 文章标签          |
| Status      | Select       | Draft / Published |
| Slug        | Rich Text    | URL 自定义部分    |
...
1. **发布到 Notion**
   ...
   node publish.js "8-创作/文章/刚写完的文章.md"
   ...
   - 可以在 Notion 里调整状态（Draft → Published）

1. **等待自动同步**
   - GitHub Action 每 6 小时检查一次

   - 或者手动触发同步

1. **上线**
   - 同步完成后自动部署到 GitHub Pages
