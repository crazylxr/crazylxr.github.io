...
- 在 settings.json 中写入核心配置（示意）：
  ...
  - ANTHROPIC_BASE_URL：[[https://api-inference.modelscope.cn](https://api-inference.modelscope.cn/)。](<[https://api-inference.modelscope.cn](https://api-inference.modelscope.cn/)./>)
